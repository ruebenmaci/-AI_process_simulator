...
Item {
    ...
    function syncFromAppState() {
        ...
        if (!feedRateField.activeFocus) feedRateField.text = String(appState.feedStream.flowRateKgph);
        if (!feedTempField.activeFocus) feedTempField.text = String(appState.feedStream.temperatureK);
        ...
        const crudeIdx = appState.feedStream.fluidNames.indexOf(appState.feedStream.selectedFluid);
    ...
    Connections {
        ...
        function onFeedRateKgphChanged() { if (!feedRateField.activeFocus) feedRateField.text = String(appState.feedStream.flowRateKgph); }
        function onFeedTempKChanged() { if (!feedTempField.activeFocus) feedTempField.text = String(appState.feedStream.temperatureK); }
    ...
    Connections {
        target: hasAppState() ? appState.feedStream : null
        function onSelectedFluidChanged() { root.syncFromAppState(); }
        function onFlowRateKgphChanged() { if (!feedRateField.activeFocus) feedRateField.text = String(appState.feedStream.flowRateKgph); }
        function onTemperatureKChanged() { if (!feedTempField.activeFocus) feedTempField.text = String(appState.feedStream.temperatureK); }
    }
        ...
        ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        ColumnLayout {
                            ...
                            ComboBox {
                                ...
                                model: hasAppState() ? appState.feedStream.fluidNames : ["Brent","West Texas Intermediate","Arab Light","Western Canadian Select","Venezuelan Heavy"]
                                ...
                                Component.onCompleted: {
                                    ...
                                    if (hasAppState()) {
                                        const i = appState.feedStream.fluidNames.indexOf(appState.feedStream.selectedFluid);
                                ...
                                onActivated: { console.log("Crude changed to:", currentText);
                                    if (hasAppState()) {
                                        appState.feedStream.selectedFluid = model[index];
                                    }
                                    else {
                    ...
                    GridLayout {
                        ...
                        ColumnLayout {
                            ...
                            TextField {
                                ...
                                color: textCol
                                background: Rectangle { radius: 10; color: inputBg; border.color: inputBorder; border.width: 1 }
                                onEditingFinished: if (hasAppState()) appState.feedStream.flowRateKgph = Number(text)
                        ...
                        ColumnLayout {
                            ...
                            TextField {
                                ...
                                onEditingFinished: if (hasAppState()) appState.feedStream.temperatureK = Number(text)
                                Component.onCompleted: root.syncFromAppState()
                            }
                        }
            ...
            Flickable {
                ...
                DrawConfigView {
                    ...
                    feedRateKgph: root.hasAppState() ? root.appState.feedStream.flowRateKgph : 0
